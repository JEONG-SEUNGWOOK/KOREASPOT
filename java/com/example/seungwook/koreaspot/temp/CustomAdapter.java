...
/**
 * Created by seungwook on 2016. 5. 23..
 */
...
public class CustomAdapter extends PagerAdapter {
    ...
    public int getCount() {
        ...
        return 4; //보여줄 View의 개수 리턴(Tab이 3개라서 3을 리턴)
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        switch( position ){
            case 0: //첫번째 Tab을 선택했을때 보여질 뷰
                //view= inflater.inflate(R.layout.activity_step_count, null);
                break;
            ...
            case 2: //세번째 Tab을 선택했을때 보여질 뷰
                ...
                break;
            case 3:
                view= inflater.inflate(R.layout.activity_weight_list, null);
                break;
        }
